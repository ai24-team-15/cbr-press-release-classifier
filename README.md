...
1. **Сбор данных:** С сайта ЦБ надо будет спарсить все пресс-релизы. Также дополнительно можно использовать данные Росстата с макростатистикой: уровень безработицы, рост ВВП, ИПЦ, итд
2. **Предобработка данных:** Создания эмбеддингов из текстов
3. **Разработка классификатора:** От простых базовых моделей TF-IDF до трансформеров. Приветствуется все!!! :) 

...
st.write("Это график, который показывает распределение пресс-релизов в двумерном пространстве с использованием метода t-SNE. t-SNE (t-distributed stochastic neighbor embedding) — это алгоритм, снижения размерности данных используемый для визуализации многомерных данных в двумерном пространстве. t-SNE способен выявлять нелинейные зависимости между данными, сокращает время обработки данных, увеличивает точность модели машинного обучения и помогает избегать переобучения. 

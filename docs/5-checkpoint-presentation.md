...
- Методы ансамблирования моделей, такие как бустинг и случайный лес, окзались хуже более простых моделей, да и качество линейных алгоритмов с трудом удалось перебить, виной этому небольшая выборка.
